...
{
    public class SheepSword : ModItem
    {
        public override void SetStaticDefaults()
        {
            DisplayName.SetDefault("Sheep Sword");
            Tooltip.SetDefault("The Sword from the soft material in the ground");  //The (English) text shown below your weapon's name
        }
